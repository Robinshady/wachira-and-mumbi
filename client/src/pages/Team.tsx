...
const attorneys: Attorney[] = [
  ...
  // New attorneys
  {
    ...
    image: "/images/team/attorney-1.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-2.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-3.jpg",
    education: [
      "LL.B, Moi University",
  ...
  },
  {
    ...
    image: "/images/team/attorney-4.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-5.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-6.jpg",
    education: [
  ...
  },
  {
    ...
    image: "/images/team/attorney-7.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-8.jpg",
    education: [
      "LL.B, Strathmore University",
  ...
  },
  {
    ...
    image: "/images/team/attorney-9.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-10.jpg",
    education: [
      "LL.B, Moi University",
  ...
  },
  {
    ...
    image: "/images/team/attorney-11.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  },
  {
    ...
    image: "/images/team/attorney-12.jpg",
    education: [
      "LL.B, University of Nairobi",
  ...
  return (
    <div className="bg-white pt-24 pb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {practiceAreas.map((area) => (
              <motion.div 
                key={area.id}
                whileHover={{ y: -5 }}
                className="bg-white p-8 rounded-lg shadow-md border-t-4 border-[var(--gold)]"
              >
                <h4 className="text-xl font-bold text-[var(--navy)] mb-4 playfair">{area.name}</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {attorneys.map((attorney, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-lg font-bold text-[var(--navy)] playfair">{attorney.name}</h4>
                  <p className="text-[var(--gold)] text-sm mb-2">{attorney.position}</p>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <details className="group cursor-pointer">
                      ...
                      <div className="pt-4 text-sm space-y-3">
                        {attorney.education && (
                          <div>
                            <h5 className="font-semibold text-[var(--navy)]">Education</h5>
                        ...
                        {attorney.languages && (
                          <div>
                            <h5 className="font-semibold text-[var(--navy)]">Languages</h5>
      ...
      <motion.section 
        ...
        transition={{ duration: 0.7 }}
        viewport={{ once: true, amount: 0.3 }}
        className="bg-[var(--navy-lighter)] py-16 mt-16"
      >
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[var(--navy)] playfair mb-4">Ready to Work with Our Legal Experts?</h2>
          <p className="text-[var(--charcoal)] max-w-2xl mx-auto mb-8">
            Our team is prepared to assist you with any legal challenge or opportunity. Contact us today to schedule a consultation.
          </p>
          <button 
            onClick={() => window.location.href = "/#contact"}
            className="inline-block bg-[var(--gold)] text-white hover:bg-[var(--navy)] px-8 py-4 rounded text-sm font-semibold uppercase tracking-wider transition-colors duration-300">
            Contact Us Today
          </button>
        </div>
      </motion.section>
